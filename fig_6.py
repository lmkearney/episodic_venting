...
ax[0].plot(time, G * time, alpha=0.15, c="k", lw=1.0)
ax[0].plot(time, p_s_sawtooth(time, G), c=sand, lw=1.0, label="sandstone")
ax[0].plot(time, time, c=mud, lw=1.0, ls=(0, (5, 0.75)), label="mudstone")

# compression and diffusion plots
ax[1].plot(time, G * time, alpha=0.15, c="k", lw=1.0)
ax[1].plot(time, time, alpha=0.3, c="k", lw=1.0, ls=(0, (5, 0.75)))
ax[1].plot(time, P_s, c=sand, lw=1.0, label="sandstone")
ax[1].plot(time, time, c=mud, lw=1.0, label="mudstone", ls=(0, (5, 0.75)))

ax[0].set_xlabel("time $t^*$")
ax[1].set_xlabel("time $t^*$")
ax[0].set_ylabel(r"average overpressure $\overline{p^*}$")
